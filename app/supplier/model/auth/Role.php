...
use app\common\model\supplier\Role as RoleModel;
use app\supplier\model\auth\UserRole as UserRoleModel;
...
class Role extends RoleModel
{
     ...
     * 获取所有角色列表
     */
    public function getTreeData($shop_supplier_id)
    {
        $all = $this->getAll($shop_supplier_id);
     ...
     * 获取所有角色
     */
    private function getAll($shop_supplier_id)
    {
        $data = $this->order(['sort' => 'asc', 'create_time' => 'asc'])->where(['shop_supplier_id'=>$shop_supplier_id])->select();
